...
if (CLIENT) then
	...
	function EFFECT:Init( data ) 
		...
		for i = 0, 4 do
            ...
            local smoke = self.emitter:Add(ix.util.GetMaterial("particle/Particle_Glow_04_Additive"), pos + VectorRand()*10)
            smoke:SetVelocity(VectorRand()*20*scale)
        ...
        self.nig = {}
		for i = 0, 15 do
			local smoke = self.emitter:Add(ix.util.GetMaterial("effects/yellowflare"), pos + VectorRand()*20)
