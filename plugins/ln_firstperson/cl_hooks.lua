-- "gamemodes\\ixhl2rp\\plugins\\ln_firstperson\\cl_hooks.lua"
...
function PLUGIN:CalcView(client, origin, angles, fov)
	...
	if (!CurView) then
		...
		CurView = LerpAngle(math.Clamp(FT * (35 * (1 - math.Clamp(ix.option.Get("smoothScale", 0.7), 0, 0.9))), 0, 1), CurView, angles + Angle(0, 0, eyeAtt.Ang.r * 0))
	end
