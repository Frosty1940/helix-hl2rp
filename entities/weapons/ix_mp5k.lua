...
SWEP.Author				= "YuRaNnNzZZ & Frosty" --Author Tooltip
...
SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(.65, .65, .65), pos = Vector(0.5, -0.1, 0), angle = Angle(0, 0, 0) },
	["ATTACH_ModKit"] = { scale = Vector(.75, .75, .75), pos = Vector(2, -0.25, 0.25), angle = Angle(0, 0, 0) },
	["ATTACH_Laser"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.05, -0.05), angle = Angle(0, 180, -90) },
}

SWEP.VElements = {
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_modkit_05.mdl", bone = "A_ModKit", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
